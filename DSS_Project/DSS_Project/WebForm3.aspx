<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WebForm3.aspx.cs" Inherits="DSS_Project.WebForm3" %>
        ...
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li runat="server" id="WebF1"><a href="WebForm1.aspx">Family Members Data</a></li>
                        <li runat="server" id="WebF2"><a href="WebForm2.aspx">DSSID House Hold</a></li>
                        <li runat="server" id="WebF4"><a href="WebForm4.aspx">Married Women</a></li>
                        <li runat="server" id="WebF5"><a href="WebForm5.aspx">Children</a></li>
                        <li runat="server" id="WebF6"><a href="WebForm6.aspx">Mother by Child</a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:GridView ID="GridView2" runat="server" EmptyDataText="No Child records." Width="65%" Font-Size="4.0mm" CssClass="footable" CellPadding="20" ForeColor="#333333" OnRowDataBound="OnRowDataBound1"  AllowSorting="True" AutoGenerateColumns="false">
        <Columns>
