<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="WebForm2.aspx.cs" Inherits="DSS_Project.WebForm2" %>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="active"><a href="WebForm2.aspx">DSSID House Hold</a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div style="text-align: right; margin-top: -15px">
        <asp:Button ID="Button2" title="Export to Excel" Height="30px" CssClass="btn btn-success btn-sm" OnClick="Button2_Click" runat="server" Text="Export to .xls" /></div>
        ...
        <asp:GridView ID="GridView1" runat="server" EmptyDataText="No Record Found." AllowPaging="True" PageSize="200" CssClass="footable headrgrd" CellPadding="4" ForeColor="#333333" OnRowDataBound="OnRowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="false">
            <Columns>
                ...
                <asp:TemplateField HeaderText="DSSID House Hold">
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton2" OnClick="Link_Button2" Text='<%#Eval("dss_id_hh") %>' runat="server" ToolTip="House Hold Members"></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:BoundField DataField="relation_hh" HeaderText="Relation House Hold" />
                <asp:BoundField DataField="current_status" HeaderText="Current Status" />
                <asp:BoundField DataField="current_date" HeaderText="Current Date" />
                <asp:BoundField DataField="dod" HeaderText="dod" />
                <asp:BoundField DataField="m_status" HeaderText="m_status" />
