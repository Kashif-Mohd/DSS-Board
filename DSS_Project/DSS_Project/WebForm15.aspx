<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WebForm15.aspx.cs" Inherits="DSS_Project.WebForm15" %>
                ...
                <li class="sub-menu">
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="active"><a href="WebForm15.aspx">Children</a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
      <h3><b>New Children: </b></h3>
    <hr style="margin-top: -10px">

       <div style="text-align: center; margin-top:0px">
        <asp:Panel ID="Panel1" runat="server" DefaultButton="Button1">
            <asp:TextBox ID="txtChildName" placeholder="Child Name" ForeColor="#446CB3" pattern=".{3,}" title="Minimum 3 characters can be enter only." onkeypress="return onlyAlphabets(event)" MaxLength="20" runat="server" Width="165px"></asp:TextBox>
          &nbsp&nbsp<asp:TextBox ID="txtDSSchild" placeholder="DSSID Child" ForeColor="#446CB3"  MaxLength="25" runat="server" Width="165px"></asp:TextBox>
            &nbsp
    ...
    <asp:GridView ID="GridView1" runat="server" EmptyDataText="No Record Found."  CssClass="footable" AllowPaging="True" PageSize="200" OnRowDataBound="OnRowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging" AllowSorting="True" ForeColor="#333333" AutoGenerateColumns="false" >
            ...
            <asp:TemplateField HeaderText="DSSID House Hold">
                <ItemTemplate>
                    <asp:LinkButton ID="Linkbutton3" OnClick="Link_Button3" Text='<%#Eval("dss_id_hh") %>' runat="server"  ToolTip="House Hold Detail">dss_id_hh</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>          
            <asp:TemplateField HeaderText="DSSID Mother">
                <ItemTemplate>
                    <asp:LinkButton ID="Linkbutton1" OnClick="Link_Button1" Text='<%#Eval("dss_id_m") %>' runat="server"  ToolTip="Married Women Info.">dssid_hh</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="DSSID Child">
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton2" OnClick="Link_Button2" Text='<%#Eval("dss_id_member") %>' runat="server"  ToolTip="Child Detail">dss_members</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
