<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WebForm5.aspx.cs" Inherits="DSS_Project.WebForm5" %>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="active"><a href="WebForm5.aspx">Children</a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <h3><b>Data of Children: </b></h3>
    <hr style="margin-top: -10px">

    <div style="text-align: center; margin-top: 0px">
        <asp:Panel ID="Panel1" runat="server" DefaultButton="Button1">
            <asp:TextBox ID="txtChildName" placeholder="Child Name" ForeColor="#446CB3"  onkeypress="return onlyAlphabets(event)" MaxLength="20" runat="server" Width="165px"></asp:TextBox>
