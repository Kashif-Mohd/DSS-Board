<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WebForm18.aspx.cs" Inherits="DSS_Project.WebForm18" %>
     ...
     <aside>
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="mt">
                    <a  class="active" href="WebForm18.aspx">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <hr style="margin-top: 5px; margin-bottom:35px">
    
    
    <h2 style="text-align:center; padding-bottom:10px"><b><u>SYNCED STATUS</u></b></h2>
    
     <asp:GridView ID="GridView2" runat="server" EmptyDataText="No Record Found." CssClass="Grd footable"  AllowPaging="True" PageSize="200"   ForeColor="#333333" AutoGenerateColumns="true" >
        ...
        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            ...
            <HeaderStyle BackColor="#5D7B9D" ForeColor="white" Font-Bold="True" Height="35px" HorizontalAlign="Right"/>
